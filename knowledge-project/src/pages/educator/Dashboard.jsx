        ...
        <div className='flex flex-wrap gap-5 items-center'>
            ...
            p-4 w-56 rounded-md'>
              ...
              <div>
                ...
                <p className='text-base text-gray-500'>Nombre total inscrits</p>
              </div>
          </div>
           ...
           <div className='flex items-center gap-3 shadow-card border border-blue-500
            p-4 w-56 rounded-md'>
              ...
              <div>
                ...
                <p className='text-base text-gray-500'>Nombre total de cours</p>
              </div>
          </div>
           ...
           <div className='flex items-center gap-3 shadow-card border border-blue-500
            p-4 w-56 rounded-md'>
              ...
              <div>
                ...
                <p className='text-base text-gray-500'> Total en Euros</p>
              </div>
          </div>
          ...
          <div>
            <h2 className='pb-4 text-lg font-medium'> Dernier inscrits</h2>
                ...
                <tbody className='text-sm text-gray-500'>
                  {dashboardData.enrolledStudentsData.map((item, index) => (
                    <tr key={index} className='border-b border-gray-500/20'>
                      <td className='md:px-4 px-2 py-3 text-center hidden sm:table-cell '>
                        {index + 1}</td>
